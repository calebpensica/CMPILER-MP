...
public class APascaletParser extends Parser {
	...
	public static class AddContext extends ExpressionContext {
		public List<TerminalNode> NUM() { return getTokens(APascaletParser.NUM); }
		public TerminalNode NUM(int i) {
			return getToken(APascaletParser.NUM, i);
		}
		public TerminalNode PLUS() { return getToken(APascaletParser.PLUS, 0); }
		public AddContext(ExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof APascaletListener ) ((APascaletListener)listener).enterAdd(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof APascaletListener ) ((APascaletListener)listener).exitAdd(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof APascaletVisitor ) return ((APascaletVisitor<? extends T>)visitor).visitAdd(this);
